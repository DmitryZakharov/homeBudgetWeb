...
<body>
	...
	<display:table name="accounts" class="table table-condensed table-striped table-hover" pagesize="5">
		<display:column property="accountName" title="Account Name"
			sortable="true" />
		<display:column property="dateOfCreation" title="Date of Creation"
			sortable="true" />
		<display:column property="startingBalance" title="Starting Balance"
			sortable="false" />
	</display:table>
