      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <span style="padding:0px 10px;"><i onclick="location.href='<%=request.getContextPath()%>/j_spring_security_logout';"  class="icon-off icon-white"></i></span> 
	   ...
	   <div class="span2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="<%=request.getContextPath()%>/account/createAccount.html">add new account</a></li>
