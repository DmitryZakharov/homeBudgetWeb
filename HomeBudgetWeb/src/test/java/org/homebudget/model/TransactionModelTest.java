...
public class TransactionModelTest {
    ...
    public TransactionModelTest() {
     ...
     public void saveTransactionWithImage() {
         ...
         ResourceLoaderService resourceLoader = (ResourceLoaderService) applicationContext.getBean("resourceLoaderService");
         ...
         assertEquals(transaction.getTransactionImage().getResource().length, result.getTransactionImage().getResource().length);
         }
         finally{
